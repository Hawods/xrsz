...
<head>
    ...
    <link href="${base}/resources/css/${theme}/common.css" rel="stylesheet" type="text/css" />
    <link href="${base}/resources/css/${theme}/index.css" rel="stylesheet" type="text/css" />
...
<body>
	[#include "/${theme}/include/header.ftl" /]
	<div class="container">
	</div>
	[#include "/${theme}/include/footer.ftl" /]
